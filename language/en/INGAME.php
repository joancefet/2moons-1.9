...
$LNG['type_mission_11']  		= 'Dark Matter Research ';
...
$LNG['admin_access_1']			= 'User can access administrative functions!';
$LNG['admin_access_link']		= '<strong>Click here to Disable Access</strong>';
$LNG['admin_access_2']			= ", if you don't need it any longer";


//----------------------------------------------------------------------------//
// Topnav
$LNG['tn_vacation_mode']		= "Your account is now in vacation mode";
...
$LNG['ov_newname_specialchar']						= 'Planet name can only contain numbers, letters, spaces, _,-,.';
$LNG['ov_newname_done']										= 'The planet was successfully renamed!';
...
$LNG['ov_security_request']								= 'Password Confirmation';
$LNG['ov_security_confirm']								= 'Please confirm if you want to abandon %s .';
$LNG['ov_password']												= 'Password';
$LNG['ov_delete_planet']									= 'Abandon Planet';
...
$LNG['ov_no_admins_online']								= 'No Administrators Online';
...
$LNG['ov_noreflink']											= 'No players recruited by you';
...
$LNG['gl_out_space']											= 'Explore Space around this Solar System';
...
$LNG['gl_alliance_web_page']							= 'Alliance Webpage';
...
$LNG['gl_free_desc'] 											= 'Planet Unoccupied. Here could be the ideal place to develop a new colony';
$LNG['gl_free'] 													= 'Free';
$LNG['gl_yes'] 														= 'Yes';
$LNG['gl_no'] 														= 'No';
...
$LNG['px_fleet_movement']									= 'Fleet movement';
$LNG['px_no_fleet']												= 'There is no active fleets.';
$LNG['px_out_of_range']										= 'Out of Sensor Range';
...
$LNG['fl_flying_time']			= 'Flight Time';
$LNG['fl_flying_arrival']		= 'Arrival';
$LNG['fl_flying_return']		= 'Return';
$LNG['fl_fuel_consumption']	= 'Deuterium Consumption';
$LNG['fl_max_speed']				= 'Max Speed';
$LNG['fl_cargo_capacity']		= 'Cargo Capacity';
$LNG['fl_shortcut']					= 'Shortcuts';
$LNG['fl_my_planets']				= 'Empire Planets';
$LNG['fl_acs_title']				= 'Alliance attack';
$LNG['fl_hold_time']				= 'Defensive Hold Time';
$LNG['fl_resources']				= 'Resources';
$LNG['fl_max']							= 'max';
$LNG['fl_hours']            = 'Hours';
$LNG['fl_resources_left']		= 'Available Capacity';
$LNG['fl_all_resources']		= 'All resources';
$LNG['fl_multi_alarm']			= 'Multi alarm!';
$LNG['fl_empty_target']			= 'No mission available (the target planet exists?)';
$LNG['fl_expedition_alert_message'] = 'Explorations are dangerous missions, you can lose your entire fleet!';
...
$LNG['fl_planet_populed']						= 'Planet already populated!';
...
$LNG['fl_error_no_moon']						= 'There is no moon at these coordinates!';
...
$LNG['fl_not_all_ship_avalible']		= 'Not all ships are present';
$LNG['fl_no_expedition_slot']				= 'Expedition not available as you do not have enough fleet slots!';
$LNG['fl_invalid_mission']					= 'Invalid mission';
$LNG['fl_bash_protection']					= 'Bash Rule';
$LNG['fl_admin_attack']							= 'You can not attack the administrators';
...
$LNG['fl_player_is_noob']						= 'New Player Protection!';
$LNG['fl_player_is_strong']					= 'This player is too strong for you to attack!';
$LNG['fl_no_hold_depot']						= 'Alliance Depot is not located on the target planet';
...
$LNG['bd_working']											= 'Busy';
$LNG['bd_build']												= 'Build';
$LNG['bd_build_next_level']							= 'Build to level ';
$LNG['bd_research']											= 'Research';
$LNG['bd_tech']													= 'Research';
$LNG['bd_tech_next_level']							= 'Research to level ';
$LNG['bd_add_to_list']				        	= 'Add to list';
$LNG['bd_no_more_fields']								= 'No more free fields remaining on this planet';
$LNG['bd_remaining']										= 'Remaining:';
$LNG['bd_lab_required']					    		= 'First you have to <strong>build a Research Lab!</strong>';
...
$LNG['bd_shipyard_required']						= 'You need to <strong>build a Shipyard first</strong>';
...
$LNG['bd_protection_shield_only_one']		= 'You can only build a shield once!';
...
$LNG['bd_on']                           = 'connected';
$LNG['bd_max_builds']                   = 'You can only have a max. of %d buildings queued!';
$LNG['bd_next_level']                   = 'Next level:';
$LNG['bd_need_engine']                  = 'Requires <font color="#FF0000">%s</font> more %s';
$LNG['bd_more_engine']                  = 'Produces <font color="#00FF00">%s</font> more %s';
$LNG['bd_jump_gate_action']             = 'Jump';
$LNG['bd_cancel_warning']               = 'Cancelling will only return 60% of the resources s invested.';
...
$LNG['sys_notenough_money'] 						= 'Not enough resources on %s <a href="./game.php?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a> to build %s. <br>Your available resources are: %s %s , %s %s and %s %s. <br>The cost of construction is %s %s , %s %s and %s %s.';
$LNG['sys_nomore_level'] 								= "You're trying to destroy a building that you no longer have ( %s ).";
$LNG['sys_buildlist'] 									= "Construction List";
$LNG['sys_techlist'] 										= 'Research list';
$LNG['sys_buildlist_fail'] 				    	= "Can not Build";

//----------------------------------------------------------------------------//
// Resources Page
$LNG['rs_amount']								= 'Quantity';
$LNG['rs_lvl']									= 'Level';
$LNG['rs_production_on_planet']	= 'Resources produced on "%s"';
$LNG['rs_basic_income']					= 'Base Production';
...
$LNG['tr_cost_dm_trader']					= 'The merchant faciliates the trade for %s %s!';
$LNG['tr_not_enought']						= "Not enough %s on this planet to complete this trade";
$LNG['tr_exchange_done']					= 'Trade made with success';
$LNG['tr_exchange_error']					= 'The amount of resources are wrong or are insufficient';
$LNG['tr_call_trader']						= 'Hire a merchant';
$LNG['tr_call_trader_who_buys']		= 'Hire a merchant who purchases';
$LNG['tr_call_trader_submit']			= 'Hire Merchant';
...
$LNG['in_jump_gate_doesnt_have_one']	= 'You need a destination to jump to! Build a Jump Gate on another moon';
...
$LNG['in_title_head']  								= 'Information of'; //not used
$LNG['in_name']        								= 'Name';
...
$LNG['in_dest_durati'] 			          = 'Time to destruction';
...
$LNG['mg_receiver_block_pm']						= 'The recipient has blocked private messages';
...
$LNG['al_newname_specialchar']					= 'The Alliance and the tag must contain with alphanumeric characters, word, _, -, .!';
$LNG['al_description_message']		      = 'Message from description of Alliance';
$LNG['al_web_text']											= 'Alliance Web Site';
$LNG['al_request']					        		= 'Alliance Aplication Request';
$LNG['al_click_to_send_request']		    = 'Click here to send a message to the Alliance leadership';
$LNG['al_tag_required']					    		= 'Missing <strong>Alliance Tag</strong>';
$LNG['al_name_required']								= 'Missing <strong>Alliance Name</strong>';
$LNG['al_already_exists']								= 'Alliance %s already exists, choose another name';
$LNG['al_created']					        		= 'Alliance %s created';
...
$LNG['al_write_request']								= 'Write your application to the Alliance %s';
$LNG['al_request_deleted']			        = 'Your application request to join %s was deleted. <br>You can now <strong>request a new application</strong> or <strong>create your own Alliance</strong>';
$LNG['al_request_wait_message']         = 'You have sent a request to %s to join. <br> Please wait for a reply or delete the application.';
$LNG['al_delete_request']								= 'Delete Alliance Application Request';
...
$LNG['al_go_out_no']                    = 'No';
$LNG['al_close_ally']                   = 'Do you want to close ally requests for the Alliance?';
...
$LNG['al_no_ranks_defined']				    	= 'No Alliance Rank';
$LNG['al_request_text']									= 'Application Request';
$LNG['al_inside_text']									= 'Private Alliance Text';
$LNG['al_outside_text']									= 'External Alliance Text';
$LNG['al_transfer_alliance']						= 'Transfer Alliance Ownership';
$LNG['al_disolve_alliance']				    	= 'Dissolve Alliance';
$LNG['al_founder_rank_text']						= 'Founder';
$LNG['al_new_member_rank_text']			    = 'New Member';
$LNG['al_acept_request']								= 'Accept Alliance Application';
...
$LNG['al_decline_request']							= 'Reject Alliance Application';
$LNG['al_you_was_declined']				    	= 'Your request to join was declined ';
...
$LNG['al_no_request_pending']						= 'You have %n pending applications';
$LNG['al_name']													= 'Change Alliance Name';
$LNG['al_new_name']											= 'Name change (3-30 characters)';
$LNG['al_tag']													= 'Change Alliance Tag';
$LNG['al_new_tag']											= 'Change Tag (3-8 characters)';
$LNG['al_user_list']										= 'Members List';
$LNG['al_users_list']                   = 'Members List (user: %d)';
...
$LNG['al_goto_chat']										= 'Alliance Chat';
$LNG['al_save']													= 'Save';
$LNG['al_dlte']													= 'Delete';
$LNG['al_rank_name']										= 'Rank Title';
$LNG['al_ok']														= 'OK';
$LNG['al_num']													= 'ID';
$LNG['al_member']												= 'Name';
$LNG['al_request_from_user']            = 'Player Request';
$LNG['al_request_register_time']        = 'Registered: ';
...
$LNG['al_request_date']									= 'Application Date';
$LNG['al_transfer_alliance']						= 'Abdicate / Accept Alliance ownership?';
...
$LNG['al_apply_not_exists']							= 'Application does not exist.';
...
$LNG['al_manage_ranks']									= 'Manage Alliance Ranks';
$LNG['al_manage_members']								= 'Manage Members';
$LNG['al_manage_change_tag']						= 'Change Alliance Tag';
$LNG['al_manage_change_name']						= 'Change Alliance Name';
$LNG['al_set_max_members']							= 'Maximum Members';
$LNG['al_manage_request_min_points']    = 'Application Minimum Points';
$LNG['al_texts']												= 'Options Text';
...
$LNG['al_requests_not_allowed']			    = 'Not Possible (Alliance Application Requests Closed)';
$LNG['al_requests_allowed']				    	= 'Possible (Alliance Application Requests Open)';
$LNG['al_requests_min_points']          = ' %s points';
$LNG['al_manage_founder_rank']					= 'Founder Rank';
$LNG['al_configura_ranks']							= 'Manage Rights';
$LNG['al_create_new_rank']							= 'Create New Rank';
$LNG['al_create']												= 'Create';
$LNG['al_legend']												= 'Rank Description';
$LNG['al_legend_disolve_alliance']			= 'Dissolve Alliance';
$LNG['al_legend_kick_users']						= 'Kick Members';
$LNG['al_legend_see_requests']					= 'Show Alliance Applications';
...
$LNG['al_legend_see_connected_users']		= 'Members Online';
...
$LNG['al_tfmetall']     								= 'Metal Debris';
$LNG['al_tfkristall']   								= 'Crystal Debris';
$LNG['al_view_stats']										= 'Battle Statistics Public?';
$LNG['al_view_diplo']										= 'Diplomacy Settings Public?';
$LNG['al_view_events']									= 'View Which Events';
...
$LNG['al_no_events']										= 'No Events of Note';
...
$LNG['al_diplo_no_entry']               = '- No Pacts -';
$LNG['al_diplo_no_accept']              = '- No Applications available -';
...
$LNG['al_diplo_create_done']            = 'Pact Created';
$LNG['al_diplo_ally']                   = 'Alliance';
$LNG['al_diplo_level_des']              = 'Pact Type';
...
$LNG['al_diplo_delete']                 = 'Pact Deleted';
$LNG['al_diplo_delete_mes']             = 'The Pact (%s) between the %s and %s was deleted!';
$LNG['al_diplo_confirm_delete']         = 'Confirm Pact Deletion?';
...
$LNG['al_diplo_war']                    = 'War Declaration';
$LNG['al_diplo_war_mes']                = 'The Alliance %s and the Alliance %s just declared %s .<br>Reason:<br>%s<br><br>Information: The war is valid for 24 hours. Only after 24 hours, can war be terminated. <br>More information consult the <a href="index.php?page=rules" target="_blank">Rules</a>.';
$LNG['al_diplo_head']										= 'Diplomacy Management';
...
$LNG['al_diplo_info']										= '<p>Alliance Diplomacy Types are listed here</p>';
$LNG['al_leave_ally']										= 'Are you sure you want to leave the Alliance?';
$LNG['al_default_leader_name']					= 'Leader';
$LNG['al_rank_name']										= 'Name';
$LNG['al_rank_desc']['MEMBERLIST']			= 'Can see Members';
$LNG['al_rank_desc']['ONLINESTATE']			= 'Can see who is online';
$LNG['al_rank_desc']['TRANSFER']				= 'Can be a Leader / Founder';
$LNG['al_rank_desc']['SEEAPPLY']				= 'Can view Alliance Applications';
$LNG['al_rank_desc']['MANAGEAPPLY']			= 'Can control Alliance Applications';
$LNG['al_rank_desc']['ROUNDMAIL']				= 'Can send a Global Message';
$LNG['al_rank_desc']['ADMIN']						= 'Can edit Alliance details';
$LNG['al_rank_desc']['KICK']						= 'Can kick members from the Alliance';
$LNG['al_rank_desc']['DIPLOMATIC']			= 'Can manage Alliance Diplomacy';
$LNG['al_rank_desc']['RANKS']						= 'Can configure Alliance Ranks';
$LNG['al_rank_desc']['MANAGEUSERS']			= 'Can manage Members';
$LNG['al_rank_desc']['EVENTS']					= 'Can see Alliance Events';
$LNG['al_invalid_rank_name']						= 'Alliance Ranks can only contain numbers, letters, spaces, _, -.';
$LNG['al_make_ally_insufficient_points'] = 'You have not enough points to create a Alliance.<br>You require %s points, and you have %s points.';

//----------------------------------------------------------------------------//
// Buddy List
$LNG['bu_request_exists']					= 'Friend Request already exists';
$LNG['bu_cannot_request_yourself']= 'You can not send a Friend Request to yourself';
$LNG['bu_request_message']				= 'Friend Request';
$LNG['bu_player']									= 'Player';
$LNG['bu_request_text']						= 'Message: ';
...
$LNG['bu_no_request']             = 'No Friend Requests!';
$LNG['bu_no_buddys']              = 'No Friends!';
...
$LNG['bu_accepted_request_body']	= 'Hello %s,<br>%s accepted your Friend Request! You are now friends.';
$LNG['bu_rejected_request_title']	= 'Friend Request Rejected!';
$LNG['bu_rejected_request_body']	= 'Hello %s,<br>%s refused your request for friendship! They swiped left';
...
$LNG['nt_notes']							= 'Notes';
$LNG['nt_create_new_note']		= 'Create New Note';
...
//Options
$LNG['op_error']												= 'Error';
$LNG['op_cant_activate_vacation_mode']	= 'You can not activate the vacation mode with moving Fleets';
$LNG['op_password_changed']							= 'Password Updated';
$LNG['op_username_changed']							= 'Username Updated';
$LNG['op_options_changed']							= 'Options Updated';
$LNG['op_vacation_mode_active_message']	= 'Vacation mode is active and will end up in: ';
$LNG['op_end_vacation_mode']						= 'End Vacation';
$LNG['op_save_changes']									= 'Save Changes';
$LNG['op_admin_title_options']					= 'Administrative Options';
$LNG['op_admin_planets_protection']			= 'Enable Planet Protection';
...
$LNG['op_email_adress']									= 'E-Mail address';
$LNG['op_permanent_email_adress']				= 'Permanent E-Mail Address';
$LNG['op_general_settings']							= 'General Options';
$LNG['op_sort_planets_by']							= 'Sort Planets';
$LNG['op_sort_kind']										= 'Classification Order';
$LNG['op_lang']													= 'Language';
$LNG['op_skin_example']									= 'Theme';
$LNG['op_show_skin']										= 'Gmae Theme';
$LNG['op_deactivate_ipcheck']						= 'IP Verification Disabled';
$LNG['op_galaxy_settings']							= 'Galaxy Options';
$LNG['op_spy_probes_number']						= 'Number of Spy Probes';
$LNG['op_toolt_data']										= 'Show Tooltips (Hints)';
$LNG['op_seconds']											= 'Seconds';
$LNG['op_max_fleets_messages']					= 'Number of max messages of Fleet';
$LNG['op_show_planetmenu']							= 'View Planet Menu';
...
$LNG['op_activate_vacation_mode']				= 'Activate Vacation Mode (VM)';
$LNG['op_dlte_account']									= 'Delete Account';
$LNG['op_email_adress_descrip']					= 'You can change this E-Mail address at any time. This will become your permanent e-mail after 7 days, if you make no further changes';
$LNG['op_deactivate_ipcheck_descrip']		= 'Deactivating IP Verification  will prevent automatic security logout, which occur when the IP changes or two people are recorded in an account of different IPs. Disabling the IP check can be a security risk!';
$LNG['op_spy_probes_number_descrip']		= 'Number of probes you can send directly from the Galaxy using a Shortcut';
$LNG['op_activate_vacation_mode_descrip']	= 'Vacation Mode (VM) protects your account for as long as you are out of the game. But you can only activate it, if you have nothing under construction (Buildings, Fleet, or Defense), not under attack, and none of your Fleets are active. Once activated, you are protected against new attacks. You are not protected against existing attacks. Mine production is set at 0% so deactivating vacation mode will reset the production to 100%. Vacation Mode Activation has a minimum time of 48 hours. Only then can it be disabled.';
$LNG['op_dlte_account_descrip']			    = 'If you enable this option your account will be automatically deleted after 7 days.';
$LNG['op_need_pass_mail']               = 'Changing E-Mail requires you to enter your Current Password';
$LNG['op_not_vaild_mail']								= 'Not a valid E-Mail!';
$LNG['op_change_mail_exist']						= '"%s" is already in use! Please choose another email';
...
$LNG['op_user_name_no_alphanumeric']    = 'Usernames can only contain alphanumeric characters!';
$LNG['op_change_name_pro_week']         = 'You can only change your username once every 7 days!';
$LNG['op_change_name_exist']            = '%s already exists, please choose another username';
$LNG['op_active_build_messages']        = 'Enable Building Construction Messages';
...
$LNG['op_timezone']											= 'Your Time Zone';
$LNG['op_block_pm']											= 'Block Private Messages (PM)';
...
$LNG['bn_players_banned_list']					= 'Banned Players List';
...
// Maintenance Mode & Banned Messaging
$LNG['css_account_banned_message'] = 'Your account has been Banned!';
$LNG['css_account_banned_expire']  = 'Your account will be Unbanned in %s!';
$LNG['css_goto_homeside']          = '<a href="./index.php">Go to Homepage</a>';
$LNG['css_server_maintrace']       = 'Server Maintenance<br><br>The game is closed.<br><br>Reason: %s';

//----------------------------------------------------------------------------//
// Actividades de Frota

$LNG['cff_aproaching']					= 'The fleet comprises of ';
$LNG['cff_ships']								= ' units';
$LNG['cff_no_fleet_data']				= 'No Fleet Data';
...
$LNG['sys_refferal_text']       = 'The player %s recruited by you reached %s points.<br><br>As you invited an player active, you will be rewarded %s %s';
...
//----------------------------------------------------------------------------//
// Combat Reports
$LNG['cr_lost_contact'] = 'Communication has been lost with the Fleet.';
...
$LNG['fa_system_not_exist']				= 'Error, Pystem does not exist';
$LNG['fa_planet_not_exist']				= 'Error, Planet does not exist';
$LNG['fa_not_enough_fuel']				= 'Error, not enough Fuel';
$LNG['fa_no_more_slots']					= 'Error, not enough Fleet Slots';
$LNG['fa_no_recyclers']						= 'Error, no Recycler\'s available';
$LNG['fa_no_fleetroom']						= 'Error, not enough cargo space for fuel';
...
$LNG['fa_vacation_mode_current']	= 'Error, you are in vaction mode';
$LNG['fa_sending']								= 'Send';

//----------------------------------------------------------------------------//
// Missiles
$LNG['ma_silo_level']							= 'Level 4 Silo Required! ';
$LNG['ma_impulse_drive_required']	= 'Impulse Drive Research Required';
...
$LNG['ma_add_missile_number']			= 'Missiles to Send! ';
...
$LNG['pl_buddy']								= 'Send Friend Request';
...
$LNG['ti_admin_open'] 					= 'Your ticket has been opened!';
$LNG['ti_admin_close'] 					= 'Your ticket was closed!';
...
$LNG['ti_submit']								= 'Send';
$LNG['ti_read']									= 'Read Ticket';
$LNG['ti_answer']								= 'Respond';
$LNG['ti_create']								= 'Ticket Created ';
$LNG['ti_responded']						= 'Ticket Response ';
$LNG['ti_not_exist']						= 'Ticket #%d does not exist!';
$LNG['ti_from']									= 'By';
$LNG['ti_re']										= 'FW:';
$LNG['ti_error_no_subject']			= 'You must enter a Subject!';
$LNG['ti_msgtime']							= 'Message sent at';
...
$LNG['bs_steal']   							= "The Defenders Fesources:";
$LNG['bs_techno']   						= "Technology";
$LNG['bs_send']   							= "Calculator";
$LNG['bs_cancel']   						= "Reset";
$LNG['bs_wait']   							= "Wait 10 seconds to begin new simulation";
...
$LNG['lo_logout']							= 'Your session was terminated';
$LNG['lo_redirect']						= 'Redirect';
$LNG['lo_notify']							= 'Will be redirected in <span id="seconds">5</span> seconds';
$LNG['lo_continue']						= 'Click here if you do not want to wait';
